...
decrements a value, "^" switches a character to uppercase and "=" pushes the current value to the output. This can let you do some pretty stupid things despite how
